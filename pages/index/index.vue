...
<template>
	<view class="content">
		<cover-image class="del-icon" @click="handleCanvasCancel" src="/static/hch-poster/del.png" alt="" srcset=""></cover-image>
		...
		<hch-dialog class="dialog-wrap template-dialog" :showModal="showTempDiolag" modal-title="模板选择" @cancel="showTempDiolag=false">
			<view class="template-wrap">
				<img class="template-item" @click="chooseTemp(i)" v-for="(item,i) in tempList" :key="i" :src="item.posterImgUrl" :data-id="item._id" alt="" srcset="">
			</view>
		</hch-dialog>
...
import {upload,chooseImgUpload,add,get} from '../../utils/apiFunc'
